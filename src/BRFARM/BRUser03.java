 ...
 * @author Wattana
 */
public class BRUser03 extends javax.swing.JFrame {
        ...
        try {
            ...
            if (jTextUsername.getText().equals("")) {
                ...
                if (Integer.valueOf(count) > 0) {
                    ...
                    cid.InsertUser(BRLogin.vFarm, jTextUsername.getText().toUpperCase(), "", jTextName.getText(), "0", "DRI");
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        // TODO add your handling code here:
        cid.UpdateUser(BRLogin.vFarm, jTextUsername.getText().toUpperCase(), "", jTextName.getText(), "0");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BRUser03.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
