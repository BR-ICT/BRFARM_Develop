 ...
 * @author Wattana
 */
public class BR01R003_CM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbApprove.setActionCommand("Approver");
                    ...
                    .addGroup(jPanelTransport4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanelTransport4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanelTransport4Layout.createSequentialGroup()
                                ...
                                .addGap(24, 24, 24)
                                .addGroup(jPanelTransport4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jcbHouse, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//            cid.InsertMTranDInvenBal(BRLogin.vFarm, sdf.format(jXDateStart.getDate()), sdf2.format(jXDateStart.getDate()), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        if ("Please Select : House".equals(jcbHouse.getSelectedItem().toString())) {
            ...
            InsertDInvenBal();
            cgr.rBR01R003("BR01R003_CM", BRLogin.vFarm, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll, vHouse, sdf2.format(jXDateStart.getDate()), sdf2.format(jXDateEnd.getDate()), jcbGiver.getSelectedItem().toString(), jcbApprove.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BR01R003_CM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
