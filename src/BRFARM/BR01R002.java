 ...
 * @author Wattana
 */
public class BR01R002 extends javax.swing.JFrame {
    ...
    public BR01R002() {
        initComponents();
        this.setTitle("BF01R002. M3 Transfer Report : " + BRLogin.vDuckBreed + " " + BRLogin.vDuckBreedDesc + " : " + BRLogin.vFarm + " " + BRLogin.vFarmDesc);
    ...
    private void initComponents() {
        ...
        jTableTransection.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Farm", "House", "Date", "MO", "Item", "Lot Number", "Qty", "Unit", "Type", "Week"
            }
        ) {
    ...
    private void TransectionDetail() {
        ...
        List<String> getListTransection = cld.GetResultM3TransectionReport(BRLogin.vFarm, sdf2.format(jXDateStart.getDate()), sdf2.format(jXDateEnd.getDate()), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
        ResetModel();
        ...
        for (int i = 0; i < getListTransection.size(); i++) {
            ...
            try {
                mTransection.insertRow(mTransection.getRowCount(), new Object[]{
                    ...
                    sdf3.format(sdf.parse(CheckTransection[2])),
                ...
                Logger.getLogger(BR01R002.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void ExportTextFile() {
        ...
        String path = PathFile + BRLogin.vDuckBreed + "01R002_" + sdf2.format(jXDateStart.getDate()) + ".txt";
        FileWriter fw;
        try {
            ...
            for (int i = 0; i < jTableTransection.getRowCount(); i++) {
                fw.write(jTableTransection.getValueAt(i, 0).toString().trim() + "      ");//6
                fw.write(jTableTransection.getValueAt(i, 1).toString().trim() + "       ");//7
                fw.write(jTableTransection.getValueAt(i, 2).toString().trim() + "                ");//16

                String value3 = jTableTransection.getValueAt(i, 3).toString().trim();
                for (int ii = value3.length(); ii < 10; ii++) {
                    value3 += " ";
                }
                fw.write(value3 + "    ");//4

                fw.write(jTableTransection.getValueAt(i, 4).toString().trim() + "         ");//9

                String value5 = jTableTransection.getValueAt(i, 5).toString().trim();
                for (int ii = value5.length(); ii < 12; ii++) {
                    value5 += " ";
                }
                fw.write(value5 + "             ");//13

                String value6 = jTableTransection.getValueAt(i, 6).toString().trim();
                for (int ii = value6.length(); ii < 10; ii++) {
                    value6 += " ";
                }
                fw.write(value6 + "            ");//12

                fw.write(jTableTransection.getValueAt(i, 7).toString().trim() + "      ");//6
                fw.write(jTableTransection.getValueAt(i, 8).toString().trim() + "     ");//5
                fw.write(jTableTransection.getValueAt(i, 9).toString().trim());
                fw.write("\r\n");
            }
            fw.write("+");
            fw.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BR01R002.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
