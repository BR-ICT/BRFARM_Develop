 ...
 * @author Wattana
 */
public class BR01R004 extends javax.swing.JFrame {
            ...
            .addGroup(jPanelTransport4Layout.createSequentialGroup()
                ...
                .addGroup(jPanelTransport4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanelTransport4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jButtonClose, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jcbApprove, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jXDateStart, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jXDateEnd, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jcbGiver, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
...
//            cid.InsertMTranDInvenBal(BRLogin.vFarm, sdf.format(jXDateStart.getDate()), sdf2.format(jXDateStart.getDate()), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        // TODO add your handling code here:
        if (jcbApprove.getSelectedItem().toString().equals("Please Select : Approve")) {
            JOptionPane.showMessageDialog(null, "Please Select Approver!");
        } else if (jcbGiver.getSelectedItem().toString().equals("Please Select : Given")) {
            JOptionPane.showMessageDialog(null, "Please Select Giver!");
        } else {
            btnPrint.enable(false);
            InsertDInvenBal();
            cgr.rBR01R004("BR01R004", BRLogin.vFarm, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll, sdf2.format(jXDateStart.getDate()), sdf2.format(jXDateEnd.getDate()), jcbGiver.getSelectedItem().toString(), jcbApprove.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BR01R004.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
