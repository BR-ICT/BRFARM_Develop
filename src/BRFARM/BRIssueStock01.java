 ...
 * @author Wattana
 */
public class BRIssueStock01 extends javax.swing.JFrame {
     ...
     */
    public BRIssueStock01() {
        initComponents();
        this.setTitle("BF01E002. Daily Issue : " + BRLogin.vDuckBreed + " " + BRLogin.vDuckBreedDesc + " : " + BRLogin.vFarm + " " + BRLogin.vFarmDesc);
        mTransection = (DefaultTableModel) jTableTransection.getModel();
        jcbHouse.setModel(new DefaultComboBoxModel(cld.GetResultHouseDesc(BRLogin.vFarm, BRLogin.vDuckBreed, BRLogin.vDuckBreed).toArray()));
        jcbPene.setModel(new DefaultComboBoxModel(cld.GetResultPeneDesc(BRLogin.vFarm).toArray()));
//        jcbType.setModel(new DefaultComboBoxModel(cld.GetResultTypeDescNonAdj(MainLogin.vFarm).toArray()));
        jcbItem = new FilterComboBox(cld.GetResultByItemDesc(BRLogin.vFarm, JPanel, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll));
    ...
    private void AddStockItem(String vItemCtrl, String vItemStock, String vSource, String vType, String date, String vHouseSelection, String vHouseLocation, String vItem, String vItemEff, String lot, Float qty) {
        ...
        if ("1".equals(vItemStock) && "".equals(vItemEff)) {
            ...
            String CheckInvenBal = crd.CheckDInvenBalDuplicate(BRLogin.vFarm, vHouseSelection, date, vItem, vItem, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
            String CheckInvenLot = crd.CheckDInvenLotDuplicate(BRLogin.vFarm, vHouseSelection, lot, date, vItem, vItem, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);

//            Insert Item Onhand DTransection
            if (!vItem.substring(0, 3).equals(BRLogin.vDuckHC + "3") && Integer.valueOf(CheckInvenBal) == 0 && Integer.valueOf(CheckInvenLot) == 0) {
                cid.InsertDInvenBal(BRLogin.vFarm, vHouseSelection, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                cid.InsertDInvenLot(BRLogin.vFarm, vHouseSelection, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                cid.InsertDTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
            }
            if (Integer.valueOf(CheckInvenBalNotDate) == 0) {
                cid.InsertInvenBal(BRLogin.vFarm, vHouseSelection, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                cid.InsertInvenLot(BRLogin.vFarm, vHouseSelection, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
                StsAddStockItem = "Yes";
            } else {
                String CheckOnhandInvenBal = crd.CheckDInvenBalDuplicate(BRLogin.vFarm, vHouseSelection, date, vItem, vItem, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                String CheckOnhandInvenLot = crd.CheckDInvenLotDuplicate(BRLogin.vFarm, vHouseSelection, lot, date, vItem, vItem, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                if (Integer.valueOf(CheckInvenLotNotDate) == 0) {
                    cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseSelection, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                    cid.InsertInvenLot(BRLogin.vFarm, vHouseSelection, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                    cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
                    StsAddStockItem = "Yes";
                } else {
                    cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseSelection, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                    cid.UpdateInvenLot(BRLogin.vFarm, vHouseSelection, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                    cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
                    StsAddStockItem = "Yes";

//                    Update Item Onhand DTransection
                    if (Integer.valueOf(CheckOnhandInvenBal) == 1 && Integer.valueOf(CheckOnhandInvenLot) == 1) {
                        cid.UpdateDInvenBal(BRLogin.vFarm, vHouseSelection, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                        cid.UpdateDInvenLot(BRLogin.vFarm, vHouseSelection, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                        cid.InsertDTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
                    }
                }
        ...
        if ("1".equals(vItemStock) && !"".equals(vItemEff)) {
            ...
            if (qty <= Float.valueOf(ItemEffOnhand)) {
                ...
                //Add Item Stock
                if (Integer.valueOf(CheckInvenBalNotDate) == 0) {
                    cid.InsertInvenBal(BRLogin.vFarm, vHouseLocation, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                    cid.InsertInvenLot(BRLogin.vFarm, vHouseLocation, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                    cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
                    StsAddStockItem = "Yes";
                } else {
                    if (Integer.valueOf(CheckInvenLotNotDate) == 0) {
                        cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseLocation, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                        cid.InsertInvenLot(BRLogin.vFarm, vHouseLocation, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed);
                        cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
                        StsAddStockItem = "Yes";
                    } else {
                        cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseLocation, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                        cid.UpdateInvenLot(BRLogin.vFarm, vHouseLocation, lot, date, vItem, String.valueOf(qty), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                        cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItem, lot, vType, vSource, String.valueOf(qty), BRLogin.vDuckBreed);
                        StsAddStockItem = "Yes";
                    }
                ...
                String CheckEffInvenBalNotDate = crd.CheckInvenBalDuplicateNotDate(BRLogin.vFarm, vHouseLocation, vItemEff, vItemEff, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                if (Integer.valueOf(CheckEffInvenBalNotDate) == 0) {
                    cid.InsertInvenBal(BRLogin.vFarm, vHouseLocation, date, vItemEff, String.valueOf(qty * -1), BRLogin.vDuckBreed);
                    cid.InsertInvenLot(BRLogin.vFarm, vHouseLocation, lot, date, vItemEff, String.valueOf(qty * -1), BRLogin.vDuckBreed);
                    cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItemEff, lot, vType, vSource, String.valueOf(qty * -1), BRLogin.vDuckBreed);
                    StsAddStockItem = "Yes";

                } else {
                    List<String> getListQtyEffInvenLot = cld.GetResultQtyInvenLot(BRLogin.vFarm, vHouseLocation, vItemEff, vItemEff, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                    for (int ii = 0; ii < getListQtyEffInvenLot.size(); ii++) {
                        ...
                        if (qty != 0) {
                            ...
                            if (qty <= Float.valueOf(vQtyEff)) {
                                cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseLocation, date, vItemEff, String.valueOf(qty * -1), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                                cid.UpdateInvenLotWithOutDate(BRLogin.vFarm, vHouseLocation, vLotEff, vItemEff, String.valueOf(qty * -1), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                                cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItemEff, lot, vType, vSource, String.valueOf(qty * -1), BRLogin.vDuckBreed);
                                qty -= qty;
                            } else {
                                cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseLocation, date, vItemEff, String.valueOf(Float.valueOf(vQtyEff) * -1), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                                cid.UpdateInvenLotWithOutDate(BRLogin.vFarm, vHouseLocation, vLotEff, vItemEff, String.valueOf(Float.valueOf(vQtyEff) * -1), BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
                                cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItemEff, lot, vType, vSource, String.valueOf(Float.valueOf(vQtyEff) * -1), BRLogin.vDuckBreed);
        ...
        if ("0".equals(vItemStock) && !"".equals(vItemEff)) {
            String ItemEffOnhand = crd.CheckItemOnhand(BRLogin.vFarm, vHouseLocation, vItemEff, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
            if (qty <= Float.valueOf(ItemEffOnhand)) {
                String CheckEffInvenBal = crd.CheckInvenBalDuplicateNotDate(BRLogin.vFarm, vHouseLocation, vItemEff, vItemEff, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
    ...
    private void IssueStockItem(String vItemCtrl, String vItemStock, String vSource, String vType, String date, String vHouseSelection, String vHouseLocation, String vItem, String vItemEff, String lot, Float qty) {
        ...
        if (qty <= Float.valueOf(ItemOnhand) && !"0".equals(ItemOnhand)) {
            ...
            for (int ii = 0; ii < getListQtyInvenLot.size(); ii++) {
                ...
                if (qty != 0) {
                    ...
                    if ("1".equals(vItemStock)) {
                        ...
                        if (Integer.valueOf(CheckInvenBalNotDate) == 0) {
                            cid.InsertInvenBal(BRLogin.vFarm, vHouseLocation, date, vItem, String.valueOf(qty * -1), BRLogin.vDuckBreedAll);
                            cid.InsertInvenLot(BRLogin.vFarm, vHouseLocation, lot, date, vItem, String.valueOf(qty * -1), BRLogin.vDuckBreedAll);
            ...
            //Add Item Stock & Item Effect Stock
            String ItemEffOnhand = crd.CheckItemOnhand(BRLogin.vFarm, vHouseLocation, vItemEff, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll);
            if ("1".equals(vItemStock) && !"".equals(vItemEff) && !"0".equals(ItemEffOnhand)) {
                ...
                if (qtyItemEff <= Float.valueOf(ItemEffOnhand)) {
                    ...
                    if (Integer.valueOf(CheckEffInvenBalNotDate) == 0) {
                        cid.InsertInvenBal(BRLogin.vFarm, vHouseLocation, date, vItemEff, String.valueOf(qtyItemEff), breed);
                        cid.InsertInvenLot(BRLogin.vFarm, vHouseLocation, lot, date, vItemEff, String.valueOf(qtyItemEff), breed);
                        cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItemEff, lot, vType, vSource, String.valueOf(qtyItemEff), breed);
                        StsAddStockItem = "Yes";
                        ...
                        for (int ii = 0; ii < getListQtyEffInvenLot.size(); ii++) {
                            ...
                            if (qtyItemEff != 0) {
                                if (qtyItemEff <= Float.valueOf(vQtyEff)) {
                                    cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseLocation, date, vItemEff, String.valueOf(qtyItemEff), breed, BRLogin.vDuckBreedAll);
                                    cid.UpdateInvenLotWithOutDate(BRLogin.vFarm, vHouseLocation, vLotEff, vItemEff, String.valueOf(qtyItemEff), breed, BRLogin.vDuckBreedAll);
                                    cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItemEff, lot, vType, vSource, String.valueOf(qtyItemEff), breed);
                                    qtyItemEff -= qtyItemEff;
                                } else {
                                    cid.UpdateInvenBalChangeDate(BRLogin.vFarm, vHouseLocation, date, vItemEff, String.valueOf(Float.valueOf(vQtyEff)), breed, BRLogin.vDuckBreedAll);
                                    cid.UpdateInvenLotWithOutDate(BRLogin.vFarm, vHouseLocation, vLotEff, vItemEff, String.valueOf(Float.valueOf(vQtyEff)), breed, BRLogin.vDuckBreedAll);
                                    cid.InsertMTransection(BRLogin.vFarm, date, vHouseSelection, vItemEff, lot, vType, vSource, String.valueOf(Float.valueOf(vQtyEff)), breed);
                                    qtyItemEff -= Float.valueOf(vQtyEff);
                                }
                            }
                        }
        ...
        if ("Please Select : House".equals(jcbHouse.getSelectedItem().toString())) {
            ...
            if (!"".equals(jTextQty.getText())) {
                ...
                if (hasDigit != true) {
                    ...
                    if ("Feed".equals(JPanel) || "Other".equals(JPanel)) {
                        remark = true;
                    } else {
                        remark = false;
                    }
    ...
    private void jPanelEggComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanelEggComponentShown
        ...
        jcbType.setModel(new DefaultComboBoxModel(cld.GetResultTypeDescWOP(BRLogin.vFarm).toArray()));
        this.remove(jcbItem);
        jcbItem.removeAll();
        jcbItem = new FilterComboBox(cld.GetResultByItemHouse(BRLogin.vFarm, vHouse, BRLogin.vDuckBreed));
        jcbItem.setBounds(82, 35, 432, 28);
    ...
    private void jPanelOtherComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanelOtherComponentShown
        ...
        String vPenePAL = crd.CheckPenePAL(BRLogin.vFarm);
        jcbPene.setSelectedItem(vPenePAL);
        jcbType.setModel(new DefaultComboBoxModel(cld.GetResultTypeDescWOM(BRLogin.vFarm).toArray()));
        this.remove(jcbItem);
        jcbItem.removeAll();
        jcbItem = new FilterComboBox(cld.GetResultByItemDesc(BRLogin.vFarm, JPanel, BRLogin.vDuckBreed, BRLogin.vDuckBreedAll));
        jcbItem.setBounds(82, 35, 432, 28);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BRIssueStock01.class
