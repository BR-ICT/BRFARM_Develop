 ...
 * @author Wattana
 */
public class BRPene01 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelName.setText("Pene Name :");

        jLabelCode.setForeground(java.awt.Color.red);
        jLabelCode.setText("Pene Code : *");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextName, javax.swing.GroupLayout.DEFAULT_SIZE, 466, Short.MAX_VALUE)
                            .addComponent(jTextCode, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 466, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    private void jButtonCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCreateActionPerformed
        ...
        try {
            ...
            if (jTextName.getText().equals("")) {
                ...
                String count = crd.CheckPeneDuplicate(BRLogin.vFarm, jTextCode.getText());

                if (Integer.valueOf(count) > 0) {
                    JOptionPane.showMessageDialog(null, jTextCode.getText() + " Data Already");
                } else {
                    cid.InsertPene(BRLogin.vFarm, jTextCode.getText(), jTextName.getText());
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        // TODO add your handling code here:
        cid.UpdatePene(BRLogin.vFarm, jTextCode.getText(), jTextName.getText());
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        if ("Yes".equals(BRData01.OnChange)) {
            jTextCode.setText(BRData01.vPENE_CODE);
            jTextName.setText(BRData01.vPENE_NAME);
            jTextName.requestFocusInWindow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BRPene01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
